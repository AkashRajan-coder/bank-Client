...
export default function Alldata() {
  ...
  useEffect(() => {
    async function axiosProd() {
      try {
        const response = await axios.get("https://bank-server-e7d6.onrender.com/data");
  ...
  async function handleDelete(id) {
    try {
      await axios.delete(`https://bank-server-e7d6.onrender.com/delete/${id}`);
  ...
  async function handleUpdate() {
    try {
      ...
      const response = await axios.put(`https://bank-server-e7d6.onrender.com/update/${editId}`, formData);
      
      console.log("Update Response:", response.data);
  
      const updatedResponse = await axios.get("https://bank-server-e7d6.onrender.com/data"); 
